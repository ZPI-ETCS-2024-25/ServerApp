    ...
    class TestMap1 : MockTestMap
    {
        ...
        private void InitializeHolders()
        {
            ...
            Dictionary<int, RailwaySignal> railwaySignalsLookup = new()
            {
                ...
                { 3, new() { RailwaySignalId = 3, TrackId = 3, Track = tracksLookup[3], DistanceFromTrackStart = 5.5, IsFacedUp = true } },
                { 33, new() { RailwaySignalId = 33, TrackId = 3, Track = tracksLookup[3], DistanceFromTrackStart = 5.5, IsFacedUp = false } },
