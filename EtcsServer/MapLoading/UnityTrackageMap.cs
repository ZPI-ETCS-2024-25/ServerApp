    ...
    public class UnityTrackageMap : ITrackageMap
    {
        ...
        public void PrepareDataForInsert()
        {
            ...
            RailwaySignalsLookup = new()
            {
                ...
                { 1515, new() { RailwaySignalId = 1515, TrackId = 15, Track = TracksLookup[15], DistanceFromTrackStart = 5.296, IsFacedUp = true } },
                { 1616, new() { RailwaySignalId = 1616, TrackId = 16, Track = TracksLookup[16], DistanceFromTrackStart = 5.346, IsFacedUp = true } },
                ...
                { 28238, new() { RailwaySignalId = 28238, TrackId = 28, Track = TracksLookup[28], DistanceFromTrackStart = TracksLookup[28].Length, IsFacedUp = true } },
                { 27237, new() { RailwaySignalId = 27237, TrackId = 27, Track = TracksLookup[27], DistanceFromTrackStart = TracksLookup[27].Length, IsFacedUp = true } },
            ...
            {
                {111, new() { SwitchDirectionId = 111, TrackFromId = 1, TrackToIdGoingStraight = 5, TrackToIdTurning = 6 } },
                {112, new() { SwitchDirectionId = 112, TrackFromId = 4, TrackToIdGoingStraight = 2, TrackToIdTurning = 240 } },
                {113, new() { SwitchDirectionId = 113, TrackFromId = 7, TrackToIdGoingStraight = 4, TrackToIdTurning = 6 } },
                {114, new() { SwitchDirectionId = 114, TrackFromId = 7, TrackToIdGoingStraight = 210, TrackToIdTurning = 8 } },
                {115, new() { SwitchDirectionId = 115, TrackFromId = 209, TrackToIdGoingStraight = 5, TrackToIdTurning = 8 } },
                {121, new() { SwitchDirectionId = 121, TrackFromId = 211, TrackToIdGoingStraight = 11, TrackToIdTurning = 12 } },
                {122, new() { SwitchDirectionId = 122, TrackFromId = 13, TrackToIdGoingStraight = 213, TrackToIdTurning = 12 } },
                {123, new() { SwitchDirectionId = 123, TrackFromId = 13, TrackToIdGoingStraight = 16, TrackToIdTurning = 14 } },
                {124, new() { SwitchDirectionId = 124, TrackFromId = 15, TrackToIdGoingStraight = 11, TrackToIdTurning = 14 } },
                {131, new() { SwitchDirectionId = 131, TrackFromId = 15, TrackToIdGoingStraight = 17, TrackToIdTurning = 18 } },
                {132, new() { SwitchDirectionId = 132, TrackFromId = 19, TrackToIdGoingStraight = 16, TrackToIdTurning = 18 } },
                {133, new() { SwitchDirectionId = 133, TrackFromId = 19, TrackToIdGoingStraight = 222, TrackToIdTurning = 20 } },
                {134, new() { SwitchDirectionId = 134, TrackFromId = 221, TrackToIdGoingStraight = 17, TrackToIdTurning = 20 } },
                {141, new() { SwitchDirectionId = 141, TrackFromId = 230, TrackToIdGoingStraight = 23, TrackToIdTurning = 24 } },
                {142, new() { SwitchDirectionId = 142, TrackFromId = 25, TrackToIdGoingStraight = 229, TrackToIdTurning = 24 } },
                {143, new() { SwitchDirectionId = 143, TrackFromId = 25, TrackToIdGoingStraight = 244, TrackToIdTurning = 26 } },
                {144, new() { SwitchDirectionId = 144, TrackFromId = 243, TrackToIdGoingStraight = 23, TrackToIdTurning = 26 } },
                {151, new() { SwitchDirectionId = 151, TrackFromId = 237, TrackToIdGoingStraight = 29, TrackToIdTurning = 30 } },
                {152, new() { SwitchDirectionId = 152, TrackFromId = 31, TrackToIdGoingStraight = 238, TrackToIdTurning = 30 } },
                {153, new() { SwitchDirectionId = 153, TrackFromId = 31, TrackToIdGoingStraight = 34, TrackToIdTurning = 32 } },
                {154, new() { SwitchDirectionId = 154, TrackFromId = 33, TrackToIdGoingStraight = 29, TrackToIdTurning = 32 } },
                {155, new() { SwitchDirectionId = 155, TrackFromId = 33, TrackToIdGoingStraight = 36, TrackToIdTurning = 241 } },
                {156, new() { SwitchDirectionId = 156, TrackFromId = 34, TrackToIdGoingStraight = 37, TrackToIdTurning = 242 } },
            };
        }
    }
}
