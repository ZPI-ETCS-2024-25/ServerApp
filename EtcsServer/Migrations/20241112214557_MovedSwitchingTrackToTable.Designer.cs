...
namespace EtcsServer.Migrations
{
    ...
    [Migration("20241112214557_MovedSwitchingTrackToTable")]
    partial class MovedSwitchingTrackToTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EtcsServer.Database.Entity.CrossingTrack", b =>
                {
                    b.Property<int>("CrossingTrackId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CrossingTrackId"));
                    ...
                    b.HasKey("CrossingTrackId");

                    b.HasIndex("TrackId");

                    b.ToTable("CrossingTracks");
                });
            ...
            modelBuilder.Entity("EtcsServer.Database.Entity.SwitchingTrack", b =>
                {
                    b.HasBaseType("EtcsServer.Database.Entity.TrackageElement");
                    ...
                    b.ToTable("SwitchingTrack", (string)null);
                });
            ...
            modelBuilder.Entity("EtcsServer.Database.Entity.SwitchRoute", b =>
                {
                    ...
                    b.HasOne("EtcsServer.Database.Entity.TrackageElement", "TrackFrom")
                        .WithMany()
                        .HasForeignKey("TrackFromId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("EtcsServer.Database.Entity.TrackageElement", "TrackTo")
                        .WithMany()
            ...
            modelBuilder.Entity("EtcsServer.Database.Entity.SwitchingTrack", b =>
                {
                    b.HasOne("EtcsServer.Database.Entity.TrackageElement", null)
                        .WithOne()
                        .HasForeignKey("EtcsServer.Database.Entity.SwitchingTrack", "TrackageElementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
